...
class CrudIntegrationTest {
    ...
    void testClientCrudOperations() throws Exception {
        ...
        String clientJson = mockMvc.perform(post("/cvet-ochey/api/v1/clients")
        ...
        mockMvc.perform(get("/cvet-ochey/api/v1/clients"))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(get("/cvet-ochey/api/v1/clients/" + clientId))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(put("/cvet-ochey/api/v1/clients/" + clientId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(createDto)))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(delete("/cvet-ochey/api/v1/clients/" + clientId))
    ...
    void testCatalogCrudOperations() throws Exception {
        ...
        String catalogJson = mockMvc.perform(post("/cvet-ochey/api/v1/catalog")
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        mockMvc.perform(get("/cvet-ochey/api/v1/catalog"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$").isArray())
                .andExpect(jsonPath("$[0].id").value(catalogId));

        // READ - Test getting catalog by ID
        mockMvc.perform(get("/cvet-ochey/api/v1/catalog/" + catalogId))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(put("/cvet-ochey/api/v1/catalog/" + catalogId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(catalogDto)))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(delete("/cvet-ochey/api/v1/catalog/" + catalogId))
                .andExpect(status().isNoContent());
    ...
    void testProductCrudOperations() throws Exception {
        ...
        String productJson = mockMvc.perform(post("/cvet-ochey/api/v1/products")
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        mockMvc.perform(get("/cvet-ochey/api/v1/products"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$").isArray())
                .andExpect(jsonPath("$[0].id").value(productId));

        // READ - Test getting product by ID
        mockMvc.perform(get("/cvet-ochey/api/v1/products/" + productId))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(put("/cvet-ochey/api/v1/products/" + productId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(productDto)))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(delete("/cvet-ochey/api/v1/products/" + productId))
                .andExpect(status().isNoContent());
    ...
    void testOrderCrudOperations() throws Exception {
        ...
        String orderJson = mockMvc.perform(post("/cvet-ochey/api/v1/orders")
                        .contentType(MediaType.APPLICATION_JSON)
        ...
        mockMvc.perform(get("/cvet-ochey/api/v1/orders"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$").isArray())
                .andExpect(jsonPath("$[0].id").value(orderId));

        // READ - Test getting order by ID
        mockMvc.perform(get("/cvet-ochey/api/v1/orders/" + orderId))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(put("/cvet-ochey/api/v1/orders/" + orderId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(orderDto)))
                .andExpect(status().isOk())
        ...
        mockMvc.perform(delete("/cvet-ochey/api/v1/orders/" + orderId))
                .andExpect(status().isNoContent());
    ...
    void testValidationErrors() throws Exception {
        ...
        // Create first client
        mockMvc.perform(post("/cvet-ochey/api/v1/clients")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(clientDto)))
                .andExpect(status().isOk());
        ...
        mockMvc.perform(post("/cvet-ochey/api/v1/orders")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(orderDto)))
                .andExpect(status().isBadRequest());
        ...
        mockMvc.perform(post("/cvet-ochey/api/v1/products")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(productDto)))
                .andExpect(status().isBadRequest());
    }
